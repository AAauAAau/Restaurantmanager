...
def menuItemJSON(restaurant_id, menu_id):
    Menu_Item = MenuItem.filter_by(id=menu_id).one()
...
def editRestaurant(restaurant_id):
    editedRestaurant = Restaurant.filter_by(id=restaurant_id).one()
    if request.method == 'POST':
...
def deleteRestaurant(restaurant_id):
    ...
    restaurantToDelete = Restaurant.filter_by(id=restaurant_id).one()
    if request.method == 'POST':
...
def editMenuItem(restaurant_id, menu_id):
    editedItem =   MenuItem.filter_by(id=menu_id).one()
    if request.method == 'POST':
        if request.form['name']:
...
def deleteMenuItem(restaurant_id, menu_id):
    itemToDelete =   MenuItem.filter_by(id=menu_id).one()
    if request.method == 'POST':
